...
# English compatibility API used by the current main branch.
read_events = lire_evenements

Journal.prepare_progress = Journal.preparar_progresso
Journal.log = Journal.noter
Journal.start = Journal.commencer
Journal.announce_step = Journal.annoncer_etape
Journal.announce_decision = Journal.annoncer_decision
Journal.announce_tool = Journal.annoncer_outil
Journal.announce_result = Journal.annoncer_resultat
Journal.finish = Journal.terminer
Journal.close = Journal.fermer
