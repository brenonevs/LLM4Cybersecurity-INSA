...
O projeto ja possui SourceReference.key, que identifica de forma estavel um campo do corpus. Essa deve ser a identidade primaria da primeira versao de reputacao.
...
O actor deve continuar sendo registrado e exibido, mas nao pode ser alterado pelo texto.
...
Nao devemos misturar automaticamente todos os tickets do mesmo autor. Isso pode ser um segundo experimento. Primeiro, usamos a chave estavel que o projeto ja rastreia.
...
1. declarar SourceReference.key como identidade primaria;
...
A primeira configuracao recomendada e:
    ...
    identidade: SourceReference.key
    alpha_inicial: 1
    beta_inicial: 1
    peso_favoravel: 1
    peso_desfavoravel: 3
